    ...
    return (
      <div style={styles.container}>
        <div style={styles.wrapper}>
          ...
          <Links />
          <div style={styles.selfUpdating}>This portfolio updates itself (<a href='http://www.atulr.com/blog-atul/web/2017/10/9/self-updating-portfolio.html' style={styles.selfbloglink}>Blog link</a>)</div>
        </div>
      </div>
    );
  }
